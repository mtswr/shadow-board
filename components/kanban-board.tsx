...
const getEmptyBoard = (boardId: string): BoardData => ({
  quests: {},
...
export const KanbanBoard = forwardRef<KanbanBoardRef, KanbanBoardProps>(({ boardId, onBoardDataChange }, ref) => {
  const [data, setData] = useState<BoardData>(getEmptyBoard(boardId))
  ...
  const handleDeleteConfirm = () => {
    ...
    const { [currentQuest.id]: deletedQuest, ...remainingQuests } = data.quests
